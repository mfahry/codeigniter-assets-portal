      ...
      <div class="x_content">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              <input type="hidden" required="required" name="asset_id" id="asset_id" value="<?php echo $procurement["ASSET_ID"]?>" />
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="status" id="status" class="form-control col-md-7 col-xs-12">
                ...
                <option value="DONE" <?php echo $procurement["STATUS"] == "CHANGE DEVICE" ? "selected":""; ?>>

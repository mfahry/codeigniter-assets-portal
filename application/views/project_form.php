    ...
    <div class="x_panel">
      ...
      <div class="x_content">
	      <form
	      	...
	      	id="form" action="<?php echo base_url("project/add"); ?>" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input
                ...
                id="start_date" name="start_date" placeholder="Start Date" required="required" />
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input
                type="text" class="form-control col-md-7 col-xs-12"
                id="end_date" name="end_date" placeholder="End Date" required="required" />
              <span class="fa fa-calendar-o form-control-feedback right" aria-hidden="true"></span>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="budget" name="budget" class="form-control col-md-7 col-xs-12" required="required"/>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="expense" name="expense" class="form-control col-md-7 col-xs-12" value="0"/>
              <span class="fa fa-money form-control-feedback right" aria-hidden="true"></span>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea
                ...
                id="description" placeholder="type a text description"></textarea>
            </div>
          </div>
          <div class="item form-group">
        ...
        <table id="datatable" class="table table-hover table-striped table-bordered" cellspacing="0">
              ...
              <th>Pilih</th>
                ...
                <td class="text-center">
                  <input type="checkbox" name="select_asset" class="select_asset"  onChange="table_select_multiple_asset(event)" data-id="<?php echo $row["ID"]; ?>" />
                </td>
							</tr>
						<?php
				  	}

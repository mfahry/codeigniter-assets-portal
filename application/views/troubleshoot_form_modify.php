    ...
    <div class="x_panel">
      ...
      <div class="x_content">
	      <form
	      	...
	      	id="form" action="<?php echo base_url("troubleshoot/modify/".$troubleshoot["ID"]); ?>" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <table id="table_asset" class="table table-hover table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                ...
                <tbody>
                  <tr>
                    <td><?php echo $asset_selected["BRAND"];?></td>
                    <td><?php echo $asset_selected["TYPE"];?></td>
                    <td><?php echo $asset_selected["GROUP_NAME"];?></td>
                    <td><?php echo $asset_selected["HOSTNAME"];?></td>
                    <td><?php echo $asset_selected["IP_ADDRESS"];?></td>
                    <td><?php echo $asset_selected["LOCATION"];?></td>
                    <td><?php echo $asset_selected["ACTIVE"];?></td>
                    <td><?php echo $asset_selected["OPERATING_SYSTEM"];?></td>
                  </tr>
                </tbody>
              </table>
              <button
              ...
              <input type="hidden" required="required" name="asset_id" id="asset_id" value="<?php echo $troubleshoot["ASSET_ID"]?>" />
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input
                ...
                value="<?php echo $troubleshoot["EVENT_DATE"]?>"/>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea
                ...
                id="description" placeholder="type a text description" required="required"><?php echo $troubleshoot["DESCRIPTION"]?></textarea>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input
                type="text" class="form-control col-md-7 col-xs-12"
                id="solved_date" name="solved_date" placeholder="Solved Date" value="<?php echo $troubleshoot["SOLVED_DATE"]; ?>"/>
              <span class="fa fa-calendar-o form-control-feedback right" aria-hidden="true"></span>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea
                ...
                id="troubleshoot" placeholder="type a text troubleshoot"><?php echo $troubleshoot["TROUBLESHOOT"]?></textarea>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="user_id_solved" class="form-control col-md-7 col-xs-12">
                ...
                foreach($user as $row){
                ?>
                  <option value="<?php echo $row["ID"] ?>" <?php echo $row["ID"] == $troubleshoot["USER_ID_SOLVED"] ? "selected" : ""; ?>>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <span>
                ...
                <input type="hidden" name="document_path_old" id="document_path_old" value="<?php echo $troubleshoot["DOCUMENT_PATH"]; ?>" />
              </span>
              <span>
                <a href="<?php echo base_url($troubleshoot["DOCUMENT_PATH"])?>" class="btn btn-xs btn-default" target="_blank">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-sm-offset-3">
              ...
              <button
                ...
                data-target=".modal-confirmation" data-url="<?php echo base_url("troubleshoot/drop/".$troubleshoot["ID"])?>">
                Hapus Data
              </button>
            </div>
          </div>

              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="ha_mode" id="ha_mode" class="form-control col-md-7 col-xs-12">
                  	<option></option>
                  	<option value="AA" <?php echo $asset["HA_MODE"]=="AA"? "selected":""; ?>>AA</option>
                  	<option value="AP" <?php echo $asset["HA_MODE"]=="AP"? "selected":""; ?>>AP</option>
                  </select>
                </div>
              </div>
              <div class="item form-group">
	          ...
	          <div id="step-3">
	          	<div class="row">
                      ...
                      ?>
                        <tr>
                          <td>
                            <input type="text" name="port[]" class="form-control" value="<?php echo $row["PORT"]; ?>" />
                          </td>
                          <td>
                            <input type="text" name="ip_address_port[]" class="form-control" value="<?php echo $row["IP_ADDRESS"]; ?>" />
                          </td>
